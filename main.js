...
points = [ {x:canvas.width/2-96,y:canvas.height/2-96}, {x:canvas.width/2+96,y:canvas.height/2-96}, {x:canvas.width/2-96,y:canvas.height/2+96}, {x:canvas.width/2+96,y:canvas.height/2+96} ];
...
function tile()
{
	...
	/*
	singleTile( points[0].x-points[2].x, points[0].y-points[2].y );
	singleTile( points[1].x-points[3].x, points[1].y-points[3].y );
	singleTile( points[2].x-points[0].x, points[2].y-points[0].y );
	singleTile( points[3].x-points[1].x, points[3].y-points[1].y );
	*/
}
